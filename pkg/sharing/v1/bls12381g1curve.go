...
func bls12381g1InitAll() {
	...
	bls12381g1.P, _ = new(big.Int).SetString(
...
func (curve *Bls12381G1Curve) Hash(msg []byte) (*big.Int, *big.Int) {
	return new(bls12381.G1).Hash(
		native.EllipticPointHasherSha256(), msg, []byte("BLS12381G1_XMD:SHA-256_SSWU_RO_"),
	).BigInt()
}
