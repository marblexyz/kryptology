...
func TestFpInvert(t *testing.T) {
	...
	sevenInv := K256FpNew().SetRaw(
		&[native.FieldLimbs]uint64{
			0xdb6db6dab6db6afd, 0x6db6db6db6db6db6, 0xb6db6db6db6db6db, 0xdb6db6db6db6db6d,
		},
	)
...
func TestFpBigInt(t *testing.T) {
	...
	e := K256FpNew().SetRaw(
		&[native.FieldLimbs]uint64{
			0xc6c6c6c63939371d, 0xc6c6c6c6c6c6c6c6, 0x8d8d8dd28485081d, 0x8484848484848484,
		},
	)
...
func TestFpSetBytesWide(t *testing.T) {
	e := K256FpNew().SetRaw(
		&[native.FieldLimbs]uint64{
			0x6aa784623e2d641e, 0x7c40617d755bae27, 0x206b7be66ed7b71b, 0x6d1e4fc581e19dc2,
		},
	)

	a := K256FpNew().SetBytesWide(
		&[64]byte{
