...
func TestFqNeg(t *testing.T) {
	...
	a.Neg(a)
	e := Bls12381FqNew().SetRaw(
		&[native.FieldLimbs]uint64{
			0xfffffffd00000003, 0xfb38ec08fffb13fc, 0x99ad88181ce5880f, 0x5bc8f5f97cd877d8,
		},
	)
	...
	e = Bls12381FqNew().SetRaw(
		&[native.FieldLimbs]uint64{
			0xfffffff000000010, 0x3bda402fffe5bfef, 0x339d80809a1d8055, 0x3eda753299d7d483,
		},
	)
	require.Equal(t, e, a)
}
...
func TestFqInvert(t *testing.T) {
	twoInv := Bls12381FqNew().SetRaw(
		&[native.FieldLimbs]uint64{
			0xffffffff, 0xac425bfd0001a401, 0xccc627f7f65e27fa, 0xc1258acd66282b7,
		},
	)
...
func TestFqBigInt(t *testing.T) {
	...
	e := Bls12381FqNew().SetRaw(
		&[native.FieldLimbs]uint64{
			0x673053fc60e06500, 0x86e6d480b4f76ada, 0x7fc68f9fefa23291, 0x3fb17f49bdda126d,
		},
	)
...
func TestFqSetBytesWide(t *testing.T) {
	e := Bls12381FqNew().SetRaw(
		&[native.FieldLimbs]uint64{
			0xc759fba87ff8c5a6, 0x9ef5194839e7df44, 0x21375d22b678bf0e, 0x38b105387033fd57,
		},
	)

	a := Bls12381FqNew().SetBytesWide(
		&[64]byte{
...
func TestFqToMontgomery(t *testing.T) {
	...
	require.Equal(
		t, [native.FieldLimbs]uint64{0x3fffffffc, 0xb1096ff400069004, 0x33189fdfd9789fea, 0x304962b3598a0adf}, v.Value,
	)
}
